...
describe('Mod feed updates', () => {
  ...
  it.each(['sort', 'owned communities'])('resets pagination when %s changes and ignores the previous request completion', async (changedOption) => {
    ...
    if (changedOption === 'sort') {
      ...
      testState.accountCommunities = { 'destination.bso': {} };
      await renderMod();
    }
  ...
  it('preserves pending pagination for feed updates and keeps owned communities and sidebar routes current', async () => {
